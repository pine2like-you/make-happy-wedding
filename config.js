...
// ── 인사말 ──
  greeting: {
    title: "소중한 분들을 초대합니다",
    content: "겨울에 태어난 두 사람은\n가장 찬란한 여름날,\n서로의 따듯한 계절이 되어주기로 했습니다.\n\n사랑과 웃음이 가득할 그 날,\n소중한 걸음으로 함께하시어\n저희의 시작을 축복해 주시면 감사하겠습니다.\n\n\n[ 화환 사양 안내 ]\n식장이 위치한 공간이 다소 협소하여\n하객분들의 안전과 편의를 위해\n축하 화환은 정중히 사양하고자 합니다.\n보내주시는 따뜻한 축복의 마음만으로도\n충분히 감사하오니 너른 양해를 부탁드립니다."
  },

  // ── 스토리 기능 제외 (에러 방지용 빈 객체 유지) ──
  story: {
    title: "",
    content: ""
  },
  ...
  accounts: {
    groom: [
      ...
      { role: "부모님", name: "박귀숙(전종복)", bank: "신한은행", number: "110-029-686429" }
    ],
    bride: [
      { role: "신부", name: "한솔", bank: "농협은행", number: "302-1786-1820-21" },
      { role: "아버지", name: "한현수", bank: "농협은행", number: "1031-2472-523" },
      { role: "어머니", name: "이숙", bank: "농협은행", number: "" }
    ]
  },

  // ── 링크 공유 시 나타나는 문구 (실제 성함으로 최적화) ──
  meta: {
    title: "전준석 ♥ 한솔 결혼합니다",
